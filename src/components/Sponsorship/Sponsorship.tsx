            ...
            <section className="py-12 px-8 bg-white text-center">
                <div className="max-w-3xl mx-auto">
                    ...
                    <p className="text-gray-600">
                        The Brilliant Brains Child Sponsorship Program links vulnerable children with international sponsors,
            ...
            <section className="py-12 px-8 bg-gray-100 text-center">
                <div className="max-w-3xl mx-auto">
                    ...
                    <ul className="text-left text-gray-600 space-y-4 list-disc list-inside">
                        <li>
                            <strong>Team Selection Method:</strong> Our team selects the most vulnerable child from a comprehensive list.
                        </li>
                        <li>
                            <strong>Open Selection Method:</strong> Sponsors can interact with children and choose the one they feel they can support.
                        </li>
                    </ul>
                </div>
            </section>
            ...
            <section className="py-12 px-8 bg-white text-center">
                <div className="max-w-3xl mx-auto">
                    ...
                    <p className="text-gray-600 mt-6">
                        <strong>Address:</strong> Busokwa Zone, Karambi Ward, North Division, Fort-Portal Tourism City, Uganda.
                    </p>
                </div>
            </section>
        </div>
