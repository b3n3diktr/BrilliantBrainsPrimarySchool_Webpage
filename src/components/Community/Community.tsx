...
import Background from "../../pictures/Food1.jpeg"
                    ...
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <ul className="text-left text-gray-600 space-y-4 list-disc list-inside">
                            <li>
                                ...
                                uplifting the standards of living for vulnerable people, especially children, through
                                education.
                            </li>
                            <li>
                                <strong>Building Connections:</strong> Community tours foster real connections and
                                understanding between different societal segments, breaking down barriers and fostering
                                empathy.
                            </li>
                            <li>
                                <strong>Providing Immediate Support:</strong> During tours, we distribute essential
                                needs
                            ...
                            <li>
                                <strong>Addressing School Dropouts:</strong> We motivate children who have dropped out
                                of
