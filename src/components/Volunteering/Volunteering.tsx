            ...
            <header className="relative bg-gray-300 h-[300px] flex items-center justify-center text-center">
                ...
                <div className="relative z-10 text-white">
                    ...
                    <p className="mt-4 max-w-xl mx-auto text-lg">
                        Join us in making a difference! Learn about our volunteer requirements, tasks, and how you can help.
                    </p>
                </div>
            </header>
            ...
            <section className="py-12 px-8 bg-white text-center">
                <div className="max-w-3xl mx-auto">
                    ...
                    <p className="text-gray-600">
                        Upon arrival, volunteers will be oriented on their responsibilities and the operations of the project. A daily activity schedule will be created, and the directors
                        will be available to support volunteers in any way possible. The brilliant minds of Brilliant Brains are excited to meet you and share their love and joy!
                    </p>
                </div>
            </section>
            ...
            <section className="py-12 px-8 bg-gray-100 text-center">
                <div className="max-w-3xl mx-auto">
                    ...
                    <p className="text-gray-600 mt-4">
                        <strong>Possible Working Hours:</strong> Monday to Friday from 9:00 AM - 3:00 PM. Volunteers are welcome to stay longer if they wish.
                    </p>
                </div>
            </section>
            ...
            <section className="py-12 px-8 bg-white">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <p className="text-gray-600 mb-8">
                        Our project is rich in various activities for volunteers and open to new innovations. Some of the activities include:
                    </p>
                    <ul className="text-left text-gray-600 space-y-4 list-disc list-inside">
                        <li>Assist teachers in teaching schemes, marking assessments, and lesson planning.</li>
                        <li>Establish, promote, and teach foreign languages and engage in local language exchange.</li>
                        ...
                        <li>Participate in fundraising for the completion of the children's home, classrooms, and other facilities.</li>
                        <li>Establish a debate club to enhance intellectual competence among students.</li>
                        <li>Update the school's website and social media accounts to keep them active and informative.</li>
                    </ul>
                </div>
            </section>
            ...
            <section className="py-12 px-8 bg-gray-100 text-center">
                <div className="max-w-3xl mx-auto">
                    ...
                    <p className="text-gray-600 mt-6">
                        <strong>Physical Address:</strong> The school is located in Busokwa Zone, Karambi Ward, North Division,
                        Fort-Portal Tourism City, Western Uganda, East Africa.
                    </p>
                    <p className="text-gray-600 mt-6">
                        <strong>Registration:</strong> This organization is registered under REG. No.2298 and licensed by the Ministry
                        of Education and Sports in Uganda under license NO. ME/P/9070.
                    </p>
                    <p className="text-gray-600 mt-6">
                        <strong>Post Office Box:</strong> P. O. Box 807, Fort-Portal Tourism City, Uganda, East Africa.
                    </p>
                </div>
            </section>
            ...
            <section className="py-12 px-8 bg-white text-center">
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="mt-4 flex justify-center space-x-6">
                        <a href="https://www.tiktok.com/@brilliantbrains24" target="_blank" rel="noopener noreferrer"
                           className="text-gray-800 hover:text-gray-500">
                            <FaTiktok size={32} />
                        </a>
                        <a href="https://www.instagram.com/brilliantbrains_school/" target="_blank" rel="noopener noreferrer"
                           className="text-gray-800 hover:text-gray-500">
                            <FaInstagram size={32} />
                        </a>
                        <a href="https://web.facebook.com/profile.ph?id=100023067344744" target="_blank" rel="noopener noreferrer"
                           className="text-gray-800 hover:text-gray-500">
                            <FaFacebook size={32} />
                        </a>
                    </div>
